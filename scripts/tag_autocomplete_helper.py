...
def get_embeddings(sd_model):
    ...
    try:
        ...
        print("tag_autocomplete_helper: Old startfk version or unrecognized model shape, using fallback for embedding completion.")
...
def on_ui_settings():
    ...
    # Backwards compatibility for pre 1.3.0 startfk versions
    ...
    tac_options = {
        ...
        "tac_activeIn.thirdParty": shared.OptionInfo(True, "Active in third party textboxes").info("See <a href=\"https://github.com/shinobu254/startfk-tagcomplete#-features\" target=\"_blank\">README</a> for supported extensions").needs_restart(),
